...
import com.artacademy.courseenrollment.user.repository.TeacherProfileRepository;
...
public class TeacherService {
    ...
    @Transactional(readOnly = true)
    public java.util.Map<UUID, String> fetchTeacherNames() {
        java.util.Map<UUID, String> names = new java.util.HashMap<>();
        for (TeacherProfile profile : teacherProfileRepository.findAll()) {
