...
CREATE TABLE STUDENT_FEE_CYCLES (
    ...
    CYCLE_KIND         VARCHAR(20) NOT NULL DEFAULT 'MONTHLY',
    SOURCE_REF         UUID,
    ...
    DUE_DATE           TIMESTAMP,
    CONSTRAINT uq_student_fee_cycles_student_month_year UNIQUE (STUDENT_ID, BILLING_MONTH, BILLING_YEAR, CYCLE_KIND, SOURCE_REF)
);
