-- =============================================================
-- Art Academy - Seed Data
-- Runs automatically on fresh DB creation via /docker-entrypoint-initdb.d/
-- All inserts use ON CONFLICT DO NOTHING — safe to re-run, no duplicates.
--
-- NOTE: auth_db and user_db entries are both inserted here for seeded users
-- because this SQL script runs at DB init time, bypassing the API and Kafka.
-- For users created at runtime via POST /students or POST /teachers, auth_db
-- credentials are created automatically via the Kafka user-created event flow.
--
-- Users seeded:
--   1 Principal : principal       / Admin@123
--   2 Teachers  : teacher.riya    / Admin@123
--                 teacher.arjun   / Admin@123
--   5 Students  : student.aditya  / Admin@123
--                 student.sneha   / Admin@123
--                 student.rahul   / Admin@123
--                 student.kavya   / Admin@123
--                 student.ananya  / Admin@123
-- =============================================================
...
INSERT INTO user_roles (user_id, role_id)
  ...
  WHERE u.username = 'principal' AND r.name IN ('PRINCIPAL', 'TEACHER', 'ADMIN')
ON CONFLICT DO NOTHING;

INSERT INTO user_roles (user_id, role_id)
  SELECT u.id, r.id FROM users u, roles r
  WHERE u.username IN ('teacher.riya', 'teacher.arjun') AND r.name = 'TEACHER'
ON CONFLICT DO NOTHING;
...
-- =============================================================
-- USER DB: Teacher and student profiles
-- =============================================================
\c user_db
...
-- =============================================================
-- ACADEMIC DB: Courses, classes, enrollments
-- =============================================================
\c academic_db
...
INSERT INTO classes (id, course_id, teacher_id, class_name, room_number, capacity, status) VALUES
  ...
  ('dddddddd-0003-0003-0003-000000000003', 'cccccccc-0003-0003-0003-000000000003', 'aaaaaaaa-0002-0002-0002-000000000002', 'Watercolor Painting - Batch A', 'Art Room', 12, 'ACTIVE'),
...
-- =============================================================
-- SCHEDULE DB: Rooms and schedules
-- =============================================================
\c schedule_db
...
INSERT INTO schedules (id, class_id, teacher_id, room_id, start_time, end_time, day_of_week) VALUES
  ...
  ('gggggggg-0006-0006-0006-000000000006', 'dddddddd-0003-0003-0003-000000000003', 'aaaaaaaa-0002-0002-0002-000000000002', 'ffffffff-0004-0004-0004-000000000004', '10:00', '12:00', 'SATURDAY'),
...
-- =============================================================
-- ATTENDANCE DB: Student attendance (relative to current date)
-- =============================================================
\c attendance_db
...
-- =============================================================
-- PAYMENT DB: Fee cycles and payments
-- =============================================================
\c payment_db
...
\echo '  principal     / Admin@123  (PRINCIPAL)'
\echo '  teacher.riya  / Admin@123  (TEACHER)'
\echo '  teacher.arjun / Admin@123  (TEACHER)'
\echo '  student.aditya / Admin@123 (STUDENT)'
\echo '  student.sneha  / Admin@123 (STUDENT)'
\echo '  student.rahul  / Admin@123 (STUDENT)'
\echo '  student.kavya  / Admin@123 (STUDENT)'
\echo '  student.ananya / Admin@123 (STUDENT)'
\echo ''
